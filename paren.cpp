...
int main() {
    ...
    constexpr std::string_view ignore_files[] {
        "site_generator/cpprefjp/site/lang/cpp11/raw_string_literals.md",
        "site_generator/cpprefjp/site/lang/cpp23/trimming_whitespaces_before_line_splicing.md",
        "site_generator/cpprefjp/site/reference/regex/regex_error/code.md",
        "site_generator/cpprefjp/site/reference/regex/regex_error.md",
        "site_generator/cpprefjp/site/reference/execution/execution/run_loop/run.md",
        "site_generator/cpprefjp/site/reference/string/basic_string/op_plus_assign.md",
        "site_generator/cpprefjp/site/reference/string/basic_string/append.md",
    };
    ...
    for (const auto& entry : fs::recursive_directory_iterator("site_generator/cpprefjp/site/")) {
        if (entry.is_regular_file() && entry.path().extension() == ".md" && not std::ranges::contains(ignore_files, entry.path())) {
            ...
            while (paren_stack.size()) {
                print_error(paren_stack.top(), "Unmatched (");
                paren_stack.pop();
            }
        }
    }
